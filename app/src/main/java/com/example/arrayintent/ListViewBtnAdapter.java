...
public class ListViewBtnAdapter extends ArrayAdapter implements View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final TextView textTextView1 = (TextView) convertView.findViewById(R.id.importTextPdt_Name);
        final TextView textTextView2 = (TextView) convertView.findViewById(R.id.importTextReal_Qty);
