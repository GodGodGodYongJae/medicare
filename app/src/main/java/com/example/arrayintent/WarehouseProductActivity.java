...
public class WarehouseProductActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //private ImageView importWareMap;*/
/*
...
//                    pdtListview.setAdapter(importListViewAdapter);
                    ...
                    // 수정후
                    warehouseAdapter = new WarehouseAdapter(context,R.layout.inwarehouse_listview_list, selectBoxList, importBean/*, clickListener*/);
                    pdtListview1 = (ListView) findViewById(R.id.pdtListview1);
                    pdtListview1.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
                    pdtListview1.setAdapter(warehouseAdapter);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // ;
        // Adapter 생성
        /*warehouseAdapter = new WarehouseAdapter(this,R.layout.inwarehouse_listview_list, selectBoxList, importBean*//*, clickListener*//*);
        pdtListview1 = (ListView) findViewById(R.id.pdtListview1);
        pdtListview1.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
        pdtListview1.setAdapter(warehouseAdapter);
        ...
        /*pdtListview1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
       ...
       // importWareMap = findViewById(R.id.importWareMap);
        ...
        //importWareMap.setOnClickListener(this);
        //QtyBtn.setOnClickListener(this);
...
/*    private void setLayout(){
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.back :
                intent = new Intent(WarehouseProductActivity.this, newMainActivity.class);
                finish();
                startActivity(intent);
                break;
...
//                    pdtListview1.setAdapter(importListViewAdapter);
                        ...
                        // 수정후
                        warehouseAdapter = new WarehouseAdapter(getApplicationContext(),R.layout.inwarehouse_listview_list, selectBoxList, importBean/*, clickListener*/);
                        pdtListview1 = (ListView) findViewById(R.id.pdtListview1);
                        pdtListview1.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
                        pdtListview1.setAdapter(warehouseAdapter);
            ...
            case R.id.importListSendBtn:
                /*intent = new Intent(WarehouseActivity.this, WarehouseImport.class);
                finish();
                startActivity(intent);*/
                /*jsonSend();
                intent = new Intent(WarehouseActivity.this, newMainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
                break;*/

            /*case R.id.importWareMap:
                //jsonSend();
                Intent mintent = new Intent(WarehouseActivity.this, WarehouseImport.class);
    ...
    private void jsonSend() {
        ...
        try{
            ...
            for(int i=0; i<selectBoxList.size(); i++){
                ...
                row.put("filecode", sendImportBean.getTrading_qr_filecode());
                row.put("order_code", sendImportBean.getOrder_code());
                row.put("supply_company_code", sendImportBean.getSupply_manager_name());
                ...
                if(conn.getResponseCode() == conn.HTTP_OK) {
                    ...
                    try{
                        ...
                        for(int i=0; i<jArray.length(); i++){
                            ...
                            //json객체.get자료형("변수명")
                            importBean.setTrading_qr_filecode(row.getString("filecode"));
    ...
    public class ImportListConnection2 extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                /*http://mespda.thethe.co.kr/import/importpdtlist2.do*/
                HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                conn.setConnectTimeout(6000);
                conn.setReadTimeout(6000);
                conn.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
