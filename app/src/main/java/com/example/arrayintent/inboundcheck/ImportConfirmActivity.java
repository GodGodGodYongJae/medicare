...
import com.example.arrayintent.CaptureAct;
import com.example.arrayintent.ImportBean;
import com.example.arrayintent.ImportListViewAdapter;
import com.example.arrayintent.ImportTradingListViewAdapter;
import com.example.arrayintent.R;
import com.example.arrayintent.newMainActivity;
...
//                    pdtListview.setAdapter(importListViewAdapter);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_importconfirm);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.back :
                intent = new Intent(ImportConfirmActivity.this, newMainActivity.class);
                finish();
                startActivity(intent);
                break;
    ...
    public class ImportListConnection extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                String str;
                URL url = new URL("http://192.168.0.227:8089/api/importpdtlist");
                //http://mespda.thethe.co.kr/import/importpdtlist.do?" + "import_barcode_scan="+strings[0]
                ...
                sendMsg = "{\"TRADING_QR_FILECODE\":\""+strings[0]+"\"}";
//                osw.write(sendMsg.replace(": ", ""));
                osw.write(sendMsg);
                osw.flush();
                Log.i("SEndMSg",sendMsg);
                Log.i("TRADING_QR_FILECODE=",strings[0]);
                String tmp2 = "";
